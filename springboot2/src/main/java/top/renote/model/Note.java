...
public class Note {
    ...
    public Note(Boolean delete, String noteName, Date gmtCreate, Date gmtModified, Notebook notebook, NoteContent noteContent) {
        this.delete = delete;
    ...
    public Note(Long noteId,Boolean delete, String noteName, Date gmtCreate, Date gmtModified, Notebook notebook, NoteContent noteContent) {
        this.delete = delete;
        this.noteName = noteName;
        this.gmtCreate = gmtCreate;
        this.gmtModified = gmtModified;
